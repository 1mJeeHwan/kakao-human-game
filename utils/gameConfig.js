...
const UPGRADE_TABLE = [
  ...
  // 3~7강: 비용 = 현재 판매가 × 10%
  { level: 3, success: 89, death: 5, fail: 6, cost: 8 },
  { level: 4, success: 84, death: 7, fail: 9, cost: 16 },
  // 5강 이후 점진적 증가 (성공률 ×0.8 적용)
  { level: 5, success: 60, death: 16, fail: 24, cost: 32 },
  { level: 6, success: 52, death: 21, fail: 27, cost: 64 },
