...
const UPGRADE_TABLE = [
  ...
  // 5강 이후 점진적 증가 (성공률 ×0.8 적용)
  { level: 5, success: 60, death: 16, fail: 24, cost: 100 },
  { level: 6, success: 52, death: 21, fail: 27, cost: 300 },
  { level: 7, success: 44, death: 25, fail: 31, cost: 1000 },
  // 8강 이후: 비용 <= 현재레벨 판매가 / 4
